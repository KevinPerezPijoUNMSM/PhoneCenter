...
include("../../Controlador/carrito.php");
    ...
    $sqlcel="select * from celular where idcel='10'";
				   ...
				   <div class="single_image">
					     <ul id="etalage">
							<li>
									...
									<img class="etalage_thumb_image" src="../../assets/img/celulares/android/xiaomi/(3).jpg" />
									<img class="etalage_source_image" src="../../assets/img/celulares/android/xiaomi/(3).jpg" />
				        ...
				        <div class="single_right">
							...
							<p>Ofrece emisor de infrarrojos, no prescinde del NFC, incluye MIUI 12.5 de serie y parte actualizado a Android 11. No dispone de conector de auriculares, aunque Xiaomi incluye un adaptador de USB C a Jack de 3,5 m en la caja.</p>
							<div class="btn_form">
				  ...
				  <div class="box-info-product">
					<p class="price2">Precio: S/<?php echo $extra['precio']?></h5></p>
					       <form action="" method="post">
								...
								<input type="hidden" name="imagen" id="imagen" value="../assets/img/celulares/android/xiaomi/(3).jpg"><br>
			...
			<div class="row">
				...
				<div class="col-md-4">
					...
					<div class="shop_desc"><a href="cel9.php">
						</a><h3><a href="cel9.php"></a><a href="cel9.php">Nokia Lumia 930</a></h3>
						<p>Microsoft </p>
						<span class="actual">S/3599.00</span><br>
						<ul class="buttons">
