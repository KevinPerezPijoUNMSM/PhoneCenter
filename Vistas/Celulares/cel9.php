...
include("../../Controlador/carrito.php");
    ...
    $sqlcel="select * from celular where idcel='9'";
      ...
      <div class="shop_top">
		<div class="container">
				   ...
				   <div class="single_image">
					     <ul id="etalage">
							<li>
									...
									<img class="etalage_thumb_image" src="../../assets/img/celulares/microsoft/(4).jpg" />
									<img class="etalage_source_image" src="../../assets/img/celulares/microsoft/(4).jpg" />
				        ...
				        <div class="single_right">
							...
							<p>El Nokia Lumia 930 es un smartphone Windows Phone 8.1 con una pantalla AMOLED 1080p de 5 pulgadas, cámara PureView de 20 megapixels, procesador Snapdragon 800 a 2.2GHz, 2GB de RAM, 32GB de almacenamiento interno, carga inalámbrica y soporte HSPA+.</p>
							<div class="btn_form">
				  ...
				  <div class="box-info-product">
					<p class="price2">Precio: S/<?php echo $extra['precio']?></h5></p>
					       <form action="" method="post">
								...
								<input type="hidden" name="imagen" id="imagen" value="../assets/img/celulares/microsoft/(4).jpg"><br>
			...
			<div class="row">
				...
				<div class="col-md-4">
					<img src="../../assets/img/otro6.jpg" class="img-responsive" alt=""/> 
					<div class="shop_desc"><a href="cel6.php">
						</a><h3><a href="cel6.php"></a><a href="cel6.php">Nokia Lumia 920</a></h3>
						<p>Microsoft </p>
						<span class="actual">S/600.00</span><br>
						<ul class="buttons">
							
							<li class="shop_btn"><a href="cel6.php">Ver más</a></li>
							<div class="clear"> </div>
					    </ul>
				    </div>
				</div>
				<div class="col-md-4">
					...
					<div class="shop_desc"><a href="cel7.php">
						</a><h3><a href="cel7.php"></a><a href="cel7.php">Iphone 11</a></h3>
						<p>Apple </p>
						<span class="actual">$12,299.00</span><br>
						<ul class="buttons">
						
							<li class="shop_btn"><a href="cel7.php">Ver más</a></li>
							<div class="clear"> </div>
				    </div>
				</div>
				<div class="col-md-4">
					<img src="../../assets/img/otro8.jpg" class="img-responsive" alt=""/> 
					<div class="shop_desc"><a href="cel8.php">
						</a><h3><a href="cel8.php"></a><a href="cel8.php">Xiaomi Mi 9T</a></h3>
						<p>Xiaomi </p>
						<span class="actual">S/1460.00</span><br>
						<ul class="buttons">
						
							<li class="shop_btn"><a href="cel8.php">Ver más</a></li>
							<div class="clear"> </div>
					    </ul>
				    </div>
				</div>
