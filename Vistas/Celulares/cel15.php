...
include("../../Controlador/carrito.php");
    ...
    $sqlcel="select * from celular where idcel='18'";
		...
		<div class="container">
				   ...
				   <div class="single_image">
					     <ul id="etalage">
							<li>
									...
									<img class="etalage_thumb_image" src="../../assets/img/(9).jpg" />
									<img class="etalage_source_image" src="../../assets/img/(9).jpg" />
				        ...
				        <div class="single_right">
							...
							<p>el iPhone 13 tiene mucho que decir: monta lo último de lo último en procesadores Apple, tiene el modo cinemático que tanto ruido ha hecho en redes sociales y mejora sustancialmente la autonomía. En Phone Center ya lo hemos probado un largo tiempo y esta aprobado por nuestros tecnicos que esperas por el tuyo.</p>
							<div class="btn_form">
				  ...
				  <div class="box-info-product">
					<p class="price2">Precio: S/<?php echo $extra['precio']?></h5></p>
					       <form action="" method="post">
								...
								<input type="hidden" name="imagen" id="imagen" value="../assets/img/(9).jpg"><br>
			...
			<div class="row">
				...
				<div class="col-md-4 product1">
					<img src="../../assets/img/5.jpg" class="img-responsive" alt=""/> 
					<div class="shop_desc"><a href="cel14.php">
						</a><h3><a href="cel14.php"></a><a href="cel14.php">Huawei nova 8 </a></h3>
						<p>HUAWEI </p>
						<span class="actual">$10,260.00</span><br>
						<ul class="buttons">
						
							<li class="shop_btn"><a href="cel14.php">Ver más</a></li>
							<div class="clear"> </div>
					    </ul>
				    </div>
				</div>
				<div class="col-md-4">
					<img src="../../assets/img/otro13.jpg" class="img-responsive" alt=""/> 
					<div class="shop_desc"><a href="cel13.php">
						</a><h3><a href="cel13.php"></a><a href="cel13.php">Galaxy Note 10 Plus</a></h3>
						<p>Samsung </p>
						<span class="actual">S/5199.00</span><br>
						<ul class="buttons">
						
							<li class="shop_btn"><a href="cel13.php">Ver más</a></li>
							<div class="clear"> </div>
					    </ul>
				    </div>
				</div>
				...
				<img src="../../assets/img/3.jpg" class="img-responsive" alt=""/> 
					<div class="shop_desc"><a href="cel2.php">
						</a><h3><a href="cel12.php"></a><a href="cel12.php">HTC 8X Phone</a></h3>
						<p>HTC </p>
						<span class="actual">$2,500.00</span><br>
						<ul class="buttons">
						
							<li class="shop_btn"><a href="cel12.php">Ver más</a></li>
							<div class="clear"> </div>
					    </ul>
				    </div>
				</div>
