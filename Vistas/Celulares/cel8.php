...
include("../../Controlador/carrito.php");
    ...
    $sqlcel="select * from celular where idcel='8'";
      ...
      <div class="shop_top">
		<div class="container">
				   ...
				   <div class="single_image">
					     <ul id="etalage">
							<li>
									...
									<img class="etalage_thumb_image" src="../../assets/img/celulares/android/xiaomi/(1).jpg" />
									<img class="etalage_source_image" src="../../assets/img/celulares/android/xiaomi/(1).jpg" />
				  ...
				  <div class="box-info-product">
					<p class="price2">Precio: S/<?php echo $extra['precio']?></h5></p>
					       <form action="" method="post">
								...
								<input type="hidden" name="imagen" id="imagen" value="../assets/img/celulares/android/xiaomi/(1).jpg"><br>
			...
			<div class="row">
				...
				<div class="col-md-4">
					<img src="../../assets/img/otro5.jpg" class="img-responsive" alt=""/> 
					<div class="shop_desc"><a href="cel5.php">
						</a><h3><a href="cel5.php"></a><a href="cel5.php">MOTO G30</a></h3>
						<p>Motorola </p>
						<span class="actual">S/930.00</span><br>
						<ul class="buttons">
						
							<li class="shop_btn"><a href="cel5.php">Ver más</a></li>
							<div class="clear"> </div>
					    </ul>
				    </div>
				</div>
