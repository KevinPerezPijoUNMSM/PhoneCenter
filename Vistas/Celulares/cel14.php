...
include("../../Controlador/carrito.php");
    ...
    $sqlcel="select * from celular where idcel='17'";
				   ...
				   <div class="single_image">
					     <ul id="etalage">
							<li>
									...
									<img class="etalage_thumb_image" src="../../assets/img/(2).jpg" />
									<img class="etalage_source_image" src="../../assets/img/(2).jpg" />
				        ...
				        <div class="single_right">
							...
							<p>Heredando toda la estética premium y los colores dinámicos de la serie nova, HUAWEI nova 8 te brinda una experiencia visual excepcional y una sensación de agarre superior. La refinada artesanía NCVM produce una magnífica exhibición de color y sombra, mientras que la curvatura 4D ofrece bordes redondeados diseñados con precisión, para un toque ultra suave.</p>
							<div class="btn_form">
				  ...
				  <div class="box-info-product">
					<p class="price2">Precio: S/<?php echo $extra['precio']?></h5></p>
					       <form action="" method="post">
								...
								<input type="hidden" name="imagen" id="imagen" value="../assets/img/(2).jpg"><br>
