...
include("../../Controlador/carrito.php");
    ...
    $sqlcel="select * from celular where idcel='15'";
				   ...
				   <div class="single_image">
					     <ul id="etalage">
							<li>
									...
									<img class="etalage_thumb_image" src="../../assets/img/(7).jpg" />
									<img class="etalage_source_image" src="../../assets/img/(7).jpg" />
				        ...
				        <div class="single_right">
							...
							<p>El iPhone 12 Pro cuenta con una pantalla Super Retina XDR de 6.1 pulgadas con un aspecto de 19.5:9. El diseño ha sido mejorado para ofrecer un teléfono inteligente de borde plano. Además, gracias a su frente de Ceramic Shield, lo que convierte al 12 pro en un dispositivo lo suficientemente fuerte para soportar maltratos y caídas sin recibir un daño real, ya que gracias a ésta nueva capa resiste hasta 4 veces más que el iPhone 11.</p>
							<div class="btn_form">
				  ...
				  <div class="box-info-product">
					<p class="price2">Precio: S/<?php echo $extra['precio']?></h5></p>
					       <form action="" method="post">
								...
								<input type="hidden" name="imagen" id="imagen" value="../assets/img/(7).jpg"><br>
