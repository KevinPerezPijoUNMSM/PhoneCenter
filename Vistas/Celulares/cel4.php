...
include("../../Controlador/carrito.php");
    ...
    $sqlcel="select * from celular where idcel='4'";
		...
		<div class="container">
				   ...
				   <div class="single_image">
					     <ul id="etalage">
							<li>
									...
									<img class="etalage_thumb_image" src="../../assets/img/celulares/microsoft/(1).jpg" />
									<img class="etalage_source_image" src="../../assets/img/celulares/microsoft/(1).jpg" />
				        ...
				        <div class="single_right">
							...
							<p>Cuenta con una pantalla WQHD de 5.7 pulgadas, procesador Snapdragon 810 octa-core, 3GB de RAM, 32GB de almacenamiento interno expandible, cámara PureView de 20 MP con flash triple y estabilización óptica de imagen, cámara frontal de 5 MP y batería de 3300 mAh.</p>
							<div class="btn_form">
				  ...
				  <div class="box-info-product">
					<p class="price2">Precio: S/<?php echo $extra['precio']?></h5></p>
					       <form action="" method="post">
								...
								<input type="hidden" name="imagen" id="imagen" value="../assets/img/celulares/microsoft/(1).jpg"><br>
			...
			<div class="row">
				...
				<div class="col-md-4 product1">
					<img src="../../assets/img/otro1.jpg" class="img-responsive" alt=""/> 
					<div class="shop_desc"><a href="cel1.php">
						</a><h3><a href="cel1.php"></a><a href="cel1.php">Samsung Galaxy S21</a></h3>
						<p>Samsung </p>
						<span class="actual">S/3599.00</span><br>
						<ul class="buttons">
							
							<li class="shop_btn"><a href="cel1.php">Ver más</a></li>
							<div class="clear"> </div>
					    </ul>
				    </div>
				</div>
				<div class="col-md-4 product1">
					...
					<div class="shop_desc"><a href="cel2.php">
						</a><h3><a href="cel2.php"></a><a href="cel2.php">Huawei nova 6 SE</a></h3>
						<p>HUAWEI </p>
