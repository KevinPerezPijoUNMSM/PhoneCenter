...
include("../../Controlador/carrito.php");
    ...
    $sqlcel="select * from celular where idcel='2'";
				   ...
				   <div class="single_image">
					     <ul id="etalage">
							<li>
									...
									<img class="etalage_thumb_image" src="../../assets/img/19.jpg" />
									<img class="etalage_source_image" src="../../assets/img/19.jpg" />
				        ...
				        <div class="single_right">
							...
							<p>El Huawei nova 6 SE es una variante del nova 6 con pantalla de 6.4 pulgadas a resolución Full HD+. Potenciado por un procesador Kirin 810 de ocho núcleos, el Huawei nova 6 SE cuenta con 8GB de memoria RAM con 128GB de espacio de almacenamiento interno, expandible mediante memorias NM.</p>
							<div class="btn_form">
				  ...
				  <div class="box-info-product">
					<p class="price2">Precio: S/<?php echo $extra['precio']?></h5></p>
					       <form action="" method="post">
								...
								<input type="hidden" name="imagen" id="imagen" value="../assets/img/19.jpg"><br>
			...
			<div class="row">
				...
				<div class="col-md-4 product1">
					...
					<div class="shop_desc"><a href="cel1.php">
						</a><h3><a href="cel2.php"></a><a href="cel1.php">Samsung Galaxy S21</a></h3>
						<p>Samsung </p>
