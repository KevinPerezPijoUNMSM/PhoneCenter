...
include("../../Controlador/carrito.php");
    ...
    $sqlcel="select * from celular where idcel='6'";
				...
				<div class="col-md-9 single_left">
				   <div class="single_image">
					     <ul id="etalage">
							<li>
								<a href="optionallink.html">
									<img class="etalage_thumb_image" src="../../assets/img/celulares/microsoft/(2).jpg" />
									<img class="etalage_source_image" src="../../assets/img/celulares/microsoft/(2).jpg" />
								</a>
							</li>
				        ...
				        <div class="single_right">
							...
							<p>El Lumia 920 posee una pantalla LCD IPS HD de 4.5 pulgadas que Nokia denomina PureMotion HD+, una cámara Carl Zeiss de 8.7 megapixels con flash LED con tecnología PureView, procesador Snapdragon S4 dual-core a 1.5GHz, 1GB de RAM, 32GB de almacenamiento interno, NFC, y conectividad 4G LTE.</p>
							<div class="btn_form">
				  ...
				  <div class="box-info-product">
					<p class="price2">Precio: S/<?php echo $extra['precio']?></h5></p>
					       <form action="" method="post">
								...
								<input type="hidden" name="imagen" id="imagen" value="../assets/img/celulares/microsoft/(2).jpg"><br>
			...
			<div class="row">
				...
				<div class="col-md-4 product1">
					...
					<div class="shop_desc"><a href="cel3.php">
						</a><h3><a href="cel3.php"></a><a href="cel3.php">Iphone 8 Plus</a></h3>
						<p>Apple </p>
				...
				<div class="col-md-4">
					...
					<div class="shop_desc"><a href="cel4.php">
						</a><h3><a href="cel4.php"></a><a href="cel4.php">Lumia 950 XL</a></h3>
						<p>	Microsoft </p>
