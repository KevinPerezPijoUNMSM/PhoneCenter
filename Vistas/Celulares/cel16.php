...
include("../../Controlador/carrito.php");
    ...
    $sqlcel="select * from celular where idcel='19'";
		...
		<div class="container">
				   ...
				   <div class="single_image">
					     <ul id="etalage">
							<li>
									...
									<img class="etalage_thumb_image" src="../../assets/img/(8).jpg" />
									<img class="etalage_source_image" src="../../assets/img/(8).jpg" />
				        ...
				        <div class="single_right">
							...
							<p>Siguiendo la trayectoria de HTC en los últimos años, el HTC HD7 no es una excepción y trae consigo un diseño genial: tanto por las formas, curvas y colores como por los materiales de su construcción. La parte frontal alberga esas 4.3 pulgadas de pantalla, rodeada por un reducidísimo marco negro. Arriba está el altavoz y un pequeño LED de estado escondido, que se iluminará cuando cargamos la batería (naranja si sigue cargando y verde cuando está por encima del 90% de carga) o para ciertos avisos, como por ejemplo cuando tenemos una llamada perdida pendiente.</p>
							<div class="btn_form">
				  ...
				  <div class="box-info-product">
					<p class="price2">Precio: S/<?php echo $extra['precio']?></h5></p>
					       <form action="" method="post">
								...
								<input type="hidden" name="imagen" id="imagen" value="../assets/img/(8).jpg"><br>
			...
			<div class="row">
				...
				<div class="col-md-4">
					...
					<div class="shop_desc"><a href="cel15.php">
						</a><h3><a href="cel15.php"></a><a href="cel15.php">Iphone 13 apple</a></h3>
						<p>Iphone </p>
						<span class="actual">S/5,599.00</span><br>
						<ul class="buttons">
						
							<li class="shop_btn"><a href="cel15.php">Ver más</a></li>
							<div class="clear"> </div>
					    </ul>
				    </div>
				</div>
