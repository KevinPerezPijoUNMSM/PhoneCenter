...
include("../../Controlador/carrito.php");
    ...
    $sqlcel="select * from celular where idcel='3'";
				   ...
				   <div class="single_image">
					     <ul id="etalage">
							<li>
									...
									<img class="etalage_thumb_image" src="../../assets/img/celulares/ios/iphone/(2).jpg" />
									<img class="etalage_source_image" src="../../assets/img/celulares/ios/iphone/(2).jpg" />
				        ...
				        <div class="single_right">
							...
							<p>Apple iPhone 8 Plus es un smartphone de 2017. Su tamaño es 158.4 x 78.1 x 7.5 mm y su peso es 202 pulgadas. Tiene ina pantalla LED-backlit IPS LCD de 5.5". La resolución es de 1080 x 1920 y una densidad de los píxeles de 401 ppi .</p>
							<div class="btn_form">
				  ...
				  <div class="box-info-product">
					<p class="price2">Precio: S/<?php echo $extra['precio']?></h5></p>
					       <form action="" method="post">
								...
								<input type="hidden" name="imagen" id="imagen" value="../assets/img/celulares/ios/iphone/(2).jpg"><br>
