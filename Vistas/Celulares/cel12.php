...
include("../../Controlador/carrito.php");
    ...
    $sqlcel="select * from celular where idcel='16'";
			...
			<div class="row">
				<div class="col-md-9 single_left">
				   <div class="single_image">
					     <ul id="etalage">
							<li>
									<img class="etalage_thumb_image" src="../../assets/img/(5).jpg" />
									<img class="etalage_source_image" src="../../assets/img/(5).jpg" />
				        ...
				        <div class="single_right">
							...
							<p>HTC 8X van a la par que los del HTC One X, la batería también. Así, con 1.800 mAh de capacidad, el resultado es el esperado, con unas 14 horas de autonomía efectivas con un uso moderado de las llamadas y las funciones multimedia pero sí del correo y las redes sociales.A nivel de calidad de sonido en las llamadas y la cobertura, no hemos encontrado errores reseñables en nuestra prueba. Las llamadas se escuchan bien tanto por nuestra parte como por la del interlocutor, incluso si usamos el altavoz, y en general la red se mantiene muy estable.</p>
							<div class="btn_form">
				  ...
				  <div class="box-info-product">
					<p class="price2">Precio: S/<?php echo $extra['precio']?></h5></p>
					       <form action="" method="post">
								...
								<input type="hidden" name="imagen" id="imagen" value="../assets/img/(5).jpg" ><br>
			...
			<div class="row">
				...
				<img src="../../assets/img/8.jpg" class="img-responsive" alt=""/> 
					<div class="shop_desc"><a href="cel11.php">
						...
						<p>Appel </p>
						<span class="actual">$14,096.00</span><br>
						<ul class="buttons">
				...
				<div class="col-md-4">
					...
					<div class="shop_desc"><a href="cel13.php">
						...
						<p>Samsung </p>
						<span class="actual">$5,190.00</span><br>
						<ul class="buttons">
